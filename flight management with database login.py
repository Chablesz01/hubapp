...
con= mysql.connect (host= "localhost", user= "root", password= "", database= "flight management")
mycursor= con.cursor()

admin = {'admin': 'admin'}
manager = {'manager': 'manager'}
standard = {'standard': 'standard'}
scheduled = {'AGENTX44': ["10:10", 'Lagos', "Delayed"], 'ADO2354': ['5:30', 'Abuja', 'Delayed'],
             'ASIA1231': ['1:49', 'London', 'Scheduled'], 'AGENT221': ['7:40', 'Canada', 'Scheduled'],
             'ASIAPACIFIC': ['2:50', 'South Africa', 'Delayed'], 'AB3452': ['9:320', 'Nigeria', 'Scheduled'],
